...
not to laugh, the busts out laughing and can't move. While he's
...
and surprise 5 Gothons who are trying to take conrol of the ship. Each
...
pod before the whole ship explodes. Ot seems like hardly any Gothons
...
"""
You jump into the pod 2 and hit the eject button. The pod easily slides out
